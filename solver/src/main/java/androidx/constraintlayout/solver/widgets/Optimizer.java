...
import static androidx.constraintlayout.solver.widgets.ConstraintWidget.*;
...
public class Optimizer {
    ...
    static void checkMatchParent(ConstraintWidgetContainer container, LinearSystem system, ConstraintWidget widget) {
        ...
        if (container.mListDimensionBehaviors[DIMENSION_HORIZONTAL] != DimensionBehaviour.WRAP_CONTENT
            && widget.mListDimensionBehaviors[DIMENSION_HORIZONTAL] == DimensionBehaviour.MATCH_PARENT) {
        ...
        if (container.mListDimensionBehaviors[DIMENSION_VERTICAL] != DimensionBehaviour.WRAP_CONTENT
            && widget.mListDimensionBehaviors[DIMENSION_VERTICAL] == DimensionBehaviour.MATCH_PARENT) {
