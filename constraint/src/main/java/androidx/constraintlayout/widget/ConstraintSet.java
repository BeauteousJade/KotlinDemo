...
public class ConstraintSet {
     ...
     */
    public static final int MATCH_CONSTRAINT = LayoutParams.MATCH_CONSTRAINT;
     ...
     */
    public static final int MATCH_CONSTRAINT_WRAP = LayoutParams.MATCH_CONSTRAINT_WRAP;

    /**
     * Calculate the size of a view in 0 dp by reducing the constrains gaps as much as possible
     */
    public static final int MATCH_CONSTRAINT_SPREAD = LayoutParams.MATCH_CONSTRAINT_SPREAD;
     ...
     * </ul>
     */
    public static final int PARENT_ID = LayoutParams.PARENT_ID;

    /**
     * The horizontal orientation.
     */
    public static final int HORIZONTAL = LayoutParams.HORIZONTAL;

    /**
     * The vertical orientation.
     */
    public static final int VERTICAL = LayoutParams.VERTICAL;
     ...
     */
    public static final int LEFT = LayoutParams.LEFT;

    /**
     * The right side of a view.
     */
    public static final int RIGHT = LayoutParams.RIGHT;

    /**
     * The top of a view.
     */
    public static final int TOP = LayoutParams.TOP;


    /**
     * The bottom side of a view.
     */
    public static final int BOTTOM = LayoutParams.BOTTOM;


    /**
     * The baseline of the text in a view.
     */
    public static final int BASELINE = LayoutParams.BASELINE;
     ...
     */
    public static final int START = LayoutParams.START;
     ...
     */
    public static final int END = LayoutParams.END;

    /**
     * Chain spread style
     */
    public static final int CHAIN_SPREAD = LayoutParams.CHAIN_SPREAD;

    /**
     * Chain spread inside style
     */
    public static final int CHAIN_SPREAD_INSIDE = LayoutParams.CHAIN_SPREAD_INSIDE;
     ...
     * Chain packed style
     */
    public static final int CHAIN_PACKED = LayoutParams.CHAIN_PACKED;
...
//                }
    ...
    public static class Constraint {
        ...
        private void fillFrom(int viewId, LayoutParams param) {
            ...
            if (currentapiVersion >= VERSION_CODES.JELLY_BEAN_MR1) {
     ...
     */
    public void applyToLayoutParams(int id, LayoutParams layoutParams) {
        if (mConstraints.containsKey(id)) {
            Constraint constraint = mConstraints.get(id);
    ...
    void applyToInternal(ConstraintLayout constraintLayout, boolean applyPostLayout) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (mConstraints.containsKey(id)) {
                ...
                LayoutParams param = (LayoutParams) view
                        .getLayoutParams();
                param.validate();
